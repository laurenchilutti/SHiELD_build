...
export BUILDDIR="/lustre/f2/dev/Lauren.Chilutti/SHiELD_github/SHiELD_build"

SBATCHARGS="--account=gfdl_f --qos=debug --time=00:10:00 --clusters=c4 --output=./stdout/%x.o%j"
